	...
	foreach(TYPENAME "CHARACTER" "COMPLEX" "INTEGER" "LOGICAL" "REAL")
		foreach(TYPESIZE 1 2 4 8 16 32 64)
			...
			if ( "BPP_${TYPENAME}${TYPESIZE}_WORKS" )
				...
				test_fort_hdf5_type("BPP_HDF5CST_${TYPENAME}${TYPESIZE}" "${TYPENAME}" "${TYPESIZE}")
				if ( "BPP_HDF5CST_${TYPENAME}${TYPESIZE}" )
					set(HDF5CSTS "${HDF5CSTS}HDF5CST_${TYPENAME}${TYPESIZE}=${BPP_HDF5CST_${TYPENAME}${TYPESIZE}}
")
				endif()
			endif()
		endforeach()
